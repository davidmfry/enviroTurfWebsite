...
const MeetOurTeam = (props) => (
    <div className="meet-our-team-container">
        ...
        <div className="meet-our-team-wrapper">
            <TeamMember className="team-member-item1"  image={"Jim-Bateman.png"} name='Jim Bateman' phoneNumber='601.672.6020' bio='Chief Executive Officer of EnviroTurf began his
...
excellence.'/>
            ...
            <TeamMember className="team-member-item3" image={"Autumn-Patterson-Johnson.png"} name='Autumn Patterson Johnson ' phoneNumber='832-465-5140' bio='Autumn holds a Major in Business and enjoys a background in sports as a former collegiate tennis player.  In addition, Autumn possesses a multilayered knowledge of the Texas school system, coming from many generations of teachers and counselors in the Texas school district. As an Enviroturf team member of three years, she has worked relentlessly to develop the Houston territory and has sold fields to public school districts, colleges and private schools.'/>
