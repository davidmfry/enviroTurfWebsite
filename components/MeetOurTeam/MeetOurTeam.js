...
const MeetOurTeam = (props) => (
    <div className="meet-our-team-container">
        ...
        <div className="meet-our-team-wrapper">
            <TeamMember className="team-member-item1" linkedin={'https://www.linkedin.com/in/james-bateman-47b576150/'} image={"Jim-Bateman.png"} name='Jim Bateman' phoneNumber='601.672.6020' bio='Chief Executive Officer of EnviroTurf began his
...
excellence.'/>
            ...
            <TeamMember className="team-member-item2" image={"Katherine-Lashley.png"} name='Katherine Lashley' phoneNumber='601.940.3622' bio='Katherine Lashley is a Project Facilitator with ETS where she coordinates and manages all ongoing ventures.  Katherine has worked on synthetic turf projects, from start to finish, throughout the Southeast and encompasses the knowledge, background and commitment to helping bring you the best field possible.  Katherine has been with ETS since 2008 and been involved with virtually every project to date.  She is a graduate of the University of Alabama, a native of Birmingham, Alabama and a resident of Mississippi for the past ten years, all of which contribute to a varied sports background.'/>

            <TeamMember className="team-member-item3" image={"Autumn-Patterson-Johnson.png"} linkedin={'https://www.linkedin.com/in/autumn-johnson-b5071884/'} name='Autumn Patterson Johnson ' phoneNumber='832-465-5140' bio='Autumn holds a Major in Business and enjoys a background in sports as a former collegiate tennis player.  In addition, Autumn possesses a multilayered knowledge of the Texas school system, coming from many generations of teachers and counselors in the Texas school district. As an Enviroturf team member of three years, she has worked relentlessly to develop the Houston territory and has sold fields to public school districts, colleges and private schools.'/>

            <TeamMember className="team-member-item4" image={"Kenny-Humphreys.png"} name='Kenny Humphreys' phoneNumber='713.419.5000' bio='Kenny brings 36 years of building trustful relationships throughout the State of Texas, to the EnviroTurf TEAM. He served the first 24 years as an educator/coach before entering the office of Athletic Director for the Spring Independent School District for a 12 year period. In 2004, he was inducted into the Texas Baseball Coaches Association “Hall of Fame” along with Roger Clemens. In 2014, he was inducted into the Texas H.S.Athletic Directors “Hall of Honor”. “I am very proud and excited to be a loyal member of this great TEAM and Company. Combining the EnviroTurf product/service with 36 years of building a trustful network, is an opportunity for great success for our clients and EnviroTurf.'/>
        </div>
