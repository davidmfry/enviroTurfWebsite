...
const Products = (props) => (
    <div className="product-container">
        <h1>Products</h1>
        <ProductCard color={"etorange"} title={'EnviroTurfDF'} description={'is a strategically blended combination' +
        ...
        <div className="product-image">
            <img src="/static/img/EnviroTurfM.png" alt="EnviroTurm M Product" width="256" height="145"/>
        </div>
        <ProductCard color={"etgreen"} title={'EnviroTurfM'} description={'sets the standard for resilience and' +
        ' performance in an' +
        ...
        <div className="product-image">
            <img src="/static/img/EnviroTurfSF.png" alt="EnviroTurm SF Product"  width="377" height="146"/>
        </div>
        <ProductCard color={"etblue"} title={'EnviroTurfSF'} description={'Specifically designed to withstand intense' +
        ' use while' +
